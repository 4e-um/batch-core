...
@Configuration
public class UsageLogMonthlyReaderConfig {

    @Value("${spring.batch.jobs.usage.fetch-size}")
    private int fetchSize;

    @Bean(name = "usageLogMonthlyReader")
    @StepScope
    public JdbcCursorItemReader<UsageLogRow> usageLogMonthlyReader(
