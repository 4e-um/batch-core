package com.template.worker.example.step;

import com.template.worker.example.processor.ExampleItemProcessor;
import com.template.worker.example.reader.ExampleItemReader;
import com.template.worker.example.writer.ExampleItemWriter;
